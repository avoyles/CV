...
\item D. Gjestvang, S. Siem, F. Zeiser, J. Randrup, R. Vogt, J.N. Wilson, F. Bello-Garrote, L.A. Bernstein, D.L. Bleuel, M. Guttormsen, A. Görgen, A.C. Larsen, K.L. Malatji, E.F. Matthews, A. Oberstedt, S. Oberstedt, T. Tornyi, G.M. Tveten, and \textbf{A.S. Voyles}, \emph{Excitation energy dependence of prompt fission $\gamma$-ray emission from  \ce{^{241}Pu^*}.} Physical Review C, \emph{Accepted Feb 2021, in press. }
% 
% % \begin{sloppypar}
...
\item Morgan B. Fox, \textbf{Andrew S. Voyles}, Jonathan T. Morrell, Lee A. Bernstein, Amanda M. Lewis, Arjan J. Koning, Jon C. Batchelder, Eva R. Birnbaum, Cathy S. Cutler, Dmitri G. Medvedev, Francois M. Nortier, Ellen M. O’Brien, and Christiaan Vermeulen, \emph{Investigating high-energy proton-induced reactions on spherical nuclei: Implications for the preequilibrium exciton model.} Physical Review C, \emph{Accepted Dec 2020, in press. }
% 
% % \begin{sloppypar}
% \ifshort \vspace{0.1cm} \href{https://arxiv.org/abs/1910.11135}{\underline{PDF}} \else  \fi 
% % \ifshort \vspace{0.1cm} \href{https://avoyles.github.io/papers/Bernstein2019_Our_Future_Nuclear_Data_Needs.pdf}{\underline{PDF}} \else  \fi 
